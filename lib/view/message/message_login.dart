...
class _MessageLogin extends State<MessageLogin> {
  @override
  Widget build(BuildContext context) {
    return Consumer<control>(builder: (context, val, child) {
      return Scaffold(
        backgroundColor: val.dataUserLogin == null
            ? Colors.white
            : const Color.fromARGB(255, 85, 85, 85),
        body: val.dataUserLogin == null
            ? Center(
                child: CircularProgressIndicator(),
              )
            : val.dataUserLogin['message'] == "User Logged In Successfully"
                ? Column(
                    children: [
                      Expanded(
                        child: Container(
                      ...
                      Container(
                        ...
                        child: Center(
                          child: TextButton(
                            onPressed: () {
                              val.statusvotebox.get("statusvote")=="true"?
                              Navigator.of(context).pushNamedAndRemoveUntil(
                                  "home", (route) => false):Navigator.of(context).pushNamed("vote");
                            },
                            child: Text(
                              val.languagebox.get("language") == "en"
                                  ?
